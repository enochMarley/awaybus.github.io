					...
					<div class="panel panel-default">
						...
						<div class="panel-content">
							<ul class="nav nav-pills nav-stacked">
								...
								<li class="active"><a href="destinations.php" class="admin-menu-option"><i class="fa fa-map-marker"></i> Destinations</a></li>
				...
				<div class="col-md-10">
					<div class="panel panel-default menu-content">
						<ul class="nav nav-tabs nav-justified">
							<li class="active"><a data-toggle="tab" href="#destinationList">List Of Destination</a></li>
							<li><a data-toggle="tab" href="#addDestination">Add Destination</a></li>
						</ul>
						<div class="tab-content">
							<div id="destinationList" class="tab-pane fade in active">
								<br>
								<div class="container-fluid destinations-div"></div>
							</div>
							<div id="addDestination" class="tab-pane fade">
								<div class="row">
									<div class="col-md-2"></div>
									<div class="col-md-8">
										<form action="../includes/server_scripts/admin/addDestination.php" class="input-form dest-form" method="post">
											<br><br>
											<input type="text" name="destination" placeholder="Name Of Destination" required><br><br>
											<button type="submit" class="btn btn-info btn-lg add-btn"><i class="fa fa-plus"></i> Add Destination</button>
										</form>
									</div>
									<div class="col-md-2"></div>
								</div>
